...
def studentInfo_parser(html_doc, user):
    try:
        ...
        student.citizenship = table_element.xpath('tr[1]/td[2]')[0].text.strip()
        student.name = table_element.xpath('tr[2]/td[1]')[0].text.strip()
        student.native_from = table_element.xpath('tr[2]/td[2]')[0].text.strip()
        ...
        student.politics = table_element.xpath('tr[4]/td[1]')[0].text.strip()
